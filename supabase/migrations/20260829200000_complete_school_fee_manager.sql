-- ============================================================
-- School Fee Invoice Management System - Full Backend Schema
-- Creates: students, invoices, invoice_items, payments,
--          invoice_counters, settings + RPC, triggers, RLS
-- Idempotent: safe to run over the earlier minimal migration.
-- ============================================================
